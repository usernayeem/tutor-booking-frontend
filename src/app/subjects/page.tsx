      ...
      <div className="bg-blue-600 pb-16 pt-24 text-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <form method="GET" action="/subjects" className="mx-auto flex max-w-lg items-center rounded-xl bg-white p-2 shadow-lg">
              ...
              />
              <Button type="submit" className="rounded-lg bg-blue-600 px-6 hover:bg-blue-700">
                Search
              </Button>
            </form>
          </div>
          ...
          {subjects.map((subject: any) => (
            <div key={subject.id} className="w-full max-w-[340px] flex">
              <Link 
                ...
                className="group flex flex-col w-full rounded-2xl border border-gray-100 bg-white p-6 shadow-sm transition-all hover:-translate-y-1 hover:shadow-xl hover:border-blue-100"
              >
