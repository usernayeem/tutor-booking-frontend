                  ...
                  <TableBody>
                    {schedules.map((schedule, i) => (
                      <TableRow key={schedule.id || i}>
                        ...
                        <TableCell>{schedule.startTime ? format(new Date(schedule.startTime), "p") : "N/A"}</TableCell>
                        <TableCell>{schedule.endTime ? format(new Date(schedule.endTime), "p") : "N/A"}</TableCell>
